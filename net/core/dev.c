...
#if defined(CONFIG_UBNT_E100) || defined(CONFIG_UBNT_E200) || defined(CONFIG_UBNT_E120) || defined(CONFIG_UBNT_E220)
void (*ubnt_netdev_name_hook)(int interface, int port, char *name) = NULL;
EXPORT_SYMBOL(ubnt_netdev_name_hook);
#endif /* defined(CONFIG_UBNT_E100) || defined(CONFIG_UBNT_E200) || defined(CONFIG_UBNT_E120) || defined(CONFIG_UBNT_E220)*/
